...
for i in schedule['data']:
    ...
    if hasattr(i, 'dow') and hasattr(i, 'starttime'):
        ...
        sched = i['schedule']
        # sched = '00:00'
        # sched = 'mon,tue,wed,thu,fri 22'
        # sched = '8:00/15' #minutes
        # sched = '8:00/2:00' #hours
        ...
        # sched = '0/5'
        # sched = 'mon..wed 30/10'
        # sched = 'mon,tue,wed 30/10'
        # sched = 'mon..fri 8..17,22:0/15'
        # sched = 'fri 12..13:5/20'
        # sched = 'fri 12,13:5/20'
        # sched = '12,14,16,18,20,22:5'
        # sched = '12/2:5'
        # sched = '12/2:00'
        # sched = '*'
        # sched = '*/1'
